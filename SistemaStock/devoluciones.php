              ...
              <table id="example1" class="table table-bordered table-striped">
               <thead>
                ...
                <tbody>
                        ...
                        <?php 
                        $CONsulta="SELECT p.idMovimiento,a.codArt, a.Descripcion, l.Nombre,r.Alumno,p.Cantid,p.FechaRegistro FROM prestamos p, registroprestamos r, articulos a INNER JOIN profesores l where l.idProfesor=r.idProfesor and a.codArt=p.codArt and p.estado='dev' GROUP by p.idMovimiento";
